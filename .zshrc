...
bindkey '^[[A' history-substring-search-up          # search history with up key using zsh-history-substring-search
bindkey '^[[B' history-substring-search-down        # search history with down key using zsh-history-substring-search
bindkey -M vicmd 'k' history-substring-search-up    # search history with k key on vi mode using zsh-history-substring-search
bindkey -M vicmd 'j' history-substring-search-down  # search history with j key on vi mode using zsh-history-substring-search
